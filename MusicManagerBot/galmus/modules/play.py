...
from galmus.tgcalls import calls, queues
from galmus.tgcalls.calls import client as ASS_ACC
from galmus.database.queue import (
    get_active_chats,
    is_active_chat,
    add_active_chat,
    remove_active_chat,
...
from galmus.utils.administrator import adminsOnly
from galmus.utils.errors import DurationLimitError
from galmus.utils.gets import get_url, get_file_name
from galmus.modules.admins import member_permissions
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = audio.title
        thumb_name = "https://telegra.ph/file/50a43cdb6445df264b91e.jpg"
        ...
        file_path = await galmus.tgcalls.convert(
        ...
        file_path = await galmus.tgcalls.convert(x)
    else:
        if len(message.command) < 2:
