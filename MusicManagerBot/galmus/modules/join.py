...
from galmus import app, ASSUSERNAME
from galmus.utils.decorators import sudo_users_only, errors
from galmus.utils.administrator import adminsOnly
from galmus.utils.filters import command
from galmus.tgcalls import client as USER


@app.on_message(
    command(["userbotjoin", "galmusjoin", "oj"]) & ~filters.private & ~filters.bot
)
@errors
...
@USER.on_message(filters.group & command(["userbotleave", "galmusleave", "galmusleft"]))
